...
% -- Set font to 'Charter', with math support --
...
\lhead{\bf STAT 123 (Course Name) -- Homework X}
\rhead{Sara Venkatraman}

% -- Document starts here --
\begin{document}

\question{1}{Write the question here\vspace{-3mm}\begin{enumerate}[(a)]\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}
  \item Part A
  \item Part B
