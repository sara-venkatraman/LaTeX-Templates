...
\usepackage{
  amsmath, amsthm, amssymb, mathtools, dsfont, units,          % Math typesetting packages (units for \nicefrac)
...
\setlength{\parskip}{1.5mm}							 % Spacing between paragraphs
...
% Natural, integer, rational, real, and complex numbers. Probability, expectation,
